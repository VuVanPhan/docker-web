<?php
	namespace Maan\Adminhtml\Login\Block;
	...
	class Index
	{
		...
		public function execute() {
			...
			$template = (!empty($template)) ? $template : "Maan_Login::default.phtml";
		...
		public function getTemplate()
		{
			...
			// var_dump($_SERVER);
			// die('---------------');
			$config = VENDOR_MAAN_PATH."Adminhtml/Login/View/layout/login_index_index.xml";
